...
import fdata from "./financedata";
import { useForm } from "react-hook-form";
import BodyAdd from "./financeView"
import ModalAdd from "./FinanceModalAdd";
...
const FinanceList = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/api/finance/get", {
      headers: {
    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Finance Activities</BlockTitle>
                ...
                ? currentItems.map((item) => {
                    return (
                      <DataTableItem key={item.id}>
                        <DataTableRow>
                          <div className="nk-tnx-type">
                            ...
                            <div className="nk-tnx-type-text">
                              <span className="tb-lead">{item.Cause}</span>
                        ...
                        <DataTableRow  size="lg">
                            <span className="tb-amount">{item.type=="receiving"?"Recieving":"Spending"}</span>
                        </DataTableRow>
