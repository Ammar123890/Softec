...
import UtilFlex from "../pages/components/UtilFlex.js";
import UtilOthers from "../pages/components/UtilOthers.js";
import UtilSizing from "../pages/components/UtilSizing.js";
import UtilSpacing from "../pages/components/UtilSpacing.js";
...
import Finance from "../pages/finance/financeList.js";
import Operation from "../pages/Operations/operationsList.js";
import Adovocacy from "../pages/Adovocacy/adovocacyList";
...
const Pages = () => {
  ...
  return (
    ...
    <Route exact path={`${process.env.PUBLIC_URL}/product`} component={Finance}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/finance`} component={Finance}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/operation`} component={Operation}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/adovocacy`} component={Adovocacy}></Route>
