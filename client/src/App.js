...
import IndexFour from "./Landing/pages/IndexFour";
import PrivateRoute2 from "./route/PrivateRoute2";
function App() {
  return (
    <div >
      <Switch>
      <PrivateRoute2 path={`${process.env.PUBLIC_URL}/home`} component={IndexFour} exact />
      {/* Auth Pages */}
      ...
      <PrivateRoute2 exact path={`${process.env.PUBLIC_URL}/auth-register`} component={Register}></PrivateRoute2>
      <PrivateRoute2 exact path={`${process.env.PUBLIC_URL}/auth-login`} component={Login}></PrivateRoute2>
